            ...
            <div>
                <nav className="navbar sticky-top shadow-sm navbar-expand-lg navbar-light py-2">
                    <div className="container">
                        ...
                        <button className="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#header01"
                    ...
                    <div className="container pt-2">
                        <div className="row align-items-center mb-5">
                            <div className="col-12 col-md-10 col-lg-5 mb-5 mb-lg-0">
                                ...
                                <p className="lead text-muted mb-4">Discover streamlined transactions, real-time inventory
                                    management, and actionable insights in one intuitive POS app.</p>
                                <div className="d-flex flex-wrap">
                                    <Link className="btn bg-gradient-primary me-2 mb-2 mb-sm-0" to="/register">Start Sale</Link>
                                    <Link className="btn bg-gradient-primary mb-2 mb-sm-0"to="/login">Login</Link>
                                </div>
                            </div>
                        ...
                        <div className="row align-items-center">
                            ...
                            <div className="col-12 col-lg-6 offset-lg-1">
                                <form action="#">
                                    ...
                                    <textarea className="form-control mb-3" name="message" cols="30" rows="10"
